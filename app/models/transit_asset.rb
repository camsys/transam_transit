  ...
  def inventory_api_json(options={})
    {
      ...
      "Funding^direct_capital_responsibility": formatted_direct_capital_responsibility,
      "Funding^percent_capital_responsibility": formatted_pcnt_capital_responsibility,
