class Infrastructure < TransamAssetRecord
  ...
  def api_json(options={})
    transit_asset.api_json(options).merge(
    {
      from_line: from_line,
      to_line: to_line,
      infrastructure_segment_unit_type: infrastructure_segment_unit_type.try(:api_json),
      ...
      shared_capital_responsibility_organization: shared_capital_responsibility_organization.try(:api_json),
