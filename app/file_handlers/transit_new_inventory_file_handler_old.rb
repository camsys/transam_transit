...
#             optional_fields_start = 14
#           end
#
#           ## Add optional fields
#
#           loader = TransitGenericOptionalFieldsLoader.new
#
#           # Populate the characteristics from the row
#           loader.process(asset, reader.read(NUM_HEADER_ROWS)[optional_fields_start..100], cells[optional_fields_start..100])
#           if loader.errors?
#             row_errored = true
#             loader.errors.each { |e| add_processing_message(2, 'warning', e)}
#           end
#           if loader.warnings?
#             loader.warnings.each { |e| add_processing_message(2, 'warning', e)}
#           end
#
