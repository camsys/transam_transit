...
class TransitDispositionUpdatesTemplateBuilder < TemplateBuilder
  ...
  def add_rows(sheet)
    ...
    assets.each do |asset|
      ...
      if @fta_asset_class.try(:class_name) == 'Facility'|| asset.class.to_s == 'Facility'
  ...
  def header_rows
    ...
    if include_mileage_columns?
      detail_row << 'VIN'
    elsif @fta_asset_class.try(:class_name) == 'Facility' || (@assets && (@assets.very_specific.class.to_s == 'Facility'))
