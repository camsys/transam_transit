...
class ServiceVehicleTamServiceLifeReport < AbstractTamServiceLifeReport
  ...
  def get_underlying_data(organization_id_list, params)
    ...
    unless policy.empty?
      ...
      formats = [:string, :string, :string, :string, :string, :string, :string, :string, :string, :integer, :string, :string, :string, :date, :date, :currency, :string, :string, :string, :integer, :decimal, :integer, :string]
    end
