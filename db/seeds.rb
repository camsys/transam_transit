...
component_subtypes = [
    {name: 'Facilities - Walls', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Foundations - Columns', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Foundations - Pilings', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Basement - Materials', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Basement - Insulation', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Basement - Slab', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Basement - Floor Underpinnings', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Superstructure / Structural Frame - Columns', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Superstructure / Structural Frame - Pillars', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Superstructure / Structural Frame - Walls', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roof - Surface', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roof - Gutters', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roof - Eaves', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roof - Skylights', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roof - Chimney Surrounds', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Exterior - Windows', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Exterior - Doors', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Exterior - Paint', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Exterior - Masonry', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Shell Appurtenances - Balconies', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Shell Appurtenances - Fire Escapes', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Shell Appurtenances - Gutters', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Shell Appurtenances - Downspouts', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Passenger Areas - Platform', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Passenger Areas - Access Tunnels / Passageways', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Partitions - Walls', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Partitions - Interior Doors', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Partitions - Fittings', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Partitions - Signage', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Stairs - Interior Stairs', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Stairs - Landings', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Finishes - Materials (walls)', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Finishes - Materials (floors)', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Finishes - Materials (ceilings)', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Finishes - Materials (all surfaces)', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Elevators', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Escalators', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Lifts (any type)', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Fixtures', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Water Distribution', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Sanitary Waste', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Rain Water Drainage', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Energy Supply', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Heat Generation and Distribution Systems', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Cooling Generation and Distribution Systems', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Testing, Balancing, Controls and Instrumentation', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Chimneys and Vents', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Sprinklers', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Standpipes', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Hydrants and Other Fire Protection Specialties', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Electrical Service & Distribution', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Lighting & Branch Wiring (Interior & Exterior)', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Communications & Security', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Lighting Protection', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Generators', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Emergency Lighting', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Maintenance & Service Equipment', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Turnstiles', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Ticket Machines', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roadways / Driveways', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roadways / Driveways - Signage', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roadways / Driveways - Markings', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Roadways / Driveways - Equipment', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Parking Lots', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Parking Lots - Signage', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Parking Lots - Markings', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Parking Lots - Equipment', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Pedestrian Areas', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Pedestrian Areas - Signage', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Pedestrian Areas - Markings', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Pedestrian Areas - Equipment', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Site Development - Fences', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Site Development - Walls', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Site Development - Miscellaneous Structures', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Landscaping & Irrigation', parent: {fta_asset_category: 'Facilities'}, active:true},
    {name: 'Site Utilities', parent: {fta_asset_category: 'Facilities'}, active:true},
