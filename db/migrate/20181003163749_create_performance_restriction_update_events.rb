class CreatePerformanceRestrictionUpdateEvents < ActiveRecord::Migration[5.2]
  def change
    ...
    add_column :asset_events, :speed_restriction, :integer, after: :sales_proceeds
    ...
    add_reference :asset_events, :infrastructure_segment_unit_type, after: :to_line
    add_column :asset_events, :from_segment, :decimal, precision: 7, scale: 2, after: :infrastructure_segment_unit_type_id
