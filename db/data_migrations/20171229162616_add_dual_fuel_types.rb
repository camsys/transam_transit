class AddDualFuelTypes < ActiveRecord::DataMigration
  def up
    dual_fuel_types = [
        ...
        {active: true, primary_fuel_type: 'Diesel Fuel', secondary_fuel_type: 'Electric Propulsion'},
        ...
        {active: true, primary_fuel_type: 'Hybrid Diesel', secondary_fuel_type: 'Electric Propulsion'},
