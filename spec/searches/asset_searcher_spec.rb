...
require_relative '../../app/searches/transit_asset_map_searcher.rb'

RSpec.describe TransitAssetMapSearcher, :type => :model do
  before { skip('TransitAssetMapSearcher not refactored for TransamAsset.') }
  ...
  it 'should be able to search by fuel type' do
    ...
    searcher = TransitAssetMapSearcher.new(:fuel_type_id => asset.fuel_type_id, :organization_id => asset.organization_id)
  ...
  it 'should be able to search by storage method type' do
    ...
    searcher = TransitAssetMapSearcher.new(:vehicle_storage_method_type_id => asset.vehicle_storage_method_type_id, :organization_id => asset.organization_id)
  ...
  it 'should be able to search by fta bus mode type' do
    ...
    searcher = TransitAssetMapSearcher.new(:fta_bus_mode_type_id  => asset.fta_bus_mode_type_id, :organization_id => asset.organization_id)
  ...
  it 'should be able to search by fta ownership type' do
    ...
    searcher = TransitAssetMapSearcher.new(:fta_ownership_type_id => asset.fta_ownership_type_id , :organization_id => asset.organization_id)
  ...
  it 'should be able to search by fta vehicle type' do
    ...
    searcher = TransitAssetMapSearcher.new(:fta_vehicle_type_id => asset.fta_vehicle_type_id , :organization_id => asset.organization_id)
  ...
  it 'should be able to search by vehicle length' do
    ...
    searcher = TransitAssetMapSearcher.new(:vehicle_length => asset.vehicle_length , :vehicle_length_comparator => '0', :organization_id => asset.organization_id)
    ...
    lesser = TransitAssetMapSearcher.new(:vehicle_length => asset.vehicle_length , :vehicle_length_comparator => '-1', :organization_id => asset.organization_id)
    ...
    greater = TransitAssetMapSearcher.new(:vehicle_length => asset.vehicle_length , :vehicle_length_comparator => '1', :organization_id => asset.organization_id)
  ...
  it 'should be able to search by seating capacity' do
    ...
    searcher = TransitAssetMapSearcher.new(:seating_capacity => asset.seating_capacity , :seating_capacity_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:seating_capacity => asset.seating_capacity , :seating_capacity_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('seating_capacity < ?',  asset.seating_capacity).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by standing capacity' do
    ...
    searcher = TransitAssetMapSearcher.new(:standing_capacity => asset.standing_capacity , :standing_capacity_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:standing_capacity => asset.standing_capacity , :standing_capacity_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('standing_capacity < ?',  asset.standing_capacity).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by wheelchair capacity' do
    ...
    searcher = TransitAssetMapSearcher.new(:wheelchair_capacity => asset.wheelchair_capacity , :wheelchair_capacity_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:wheelchair_capacity => asset.wheelchair_capacity , :wheelchair_capacity_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('wheelchair_capacity < ?',  asset.wheelchair_capacity).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by gross vehicle weight' do
    ...
    searcher = TransitAssetMapSearcher.new(:gross_vehicle_weight => asset.gross_vehicle_weight , :gross_vehicle_weight_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:gross_vehicle_weight => asset.gross_vehicle_weight , :gross_vehicle_weight_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('gross_vehicle_weight < ?',  asset.gross_vehicle_weight).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by rebuild year' do
    ...
    searcher = TransitAssetMapSearcher.new(:rebuild_year => asset.rebuild_year , :rebuild_year_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:rebuild_year => asset.rebuild_year , :rebuild_year_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('rebuild_year < ?',  asset.rebuild_year).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by current mileage' do
    ...
    searcher = TransitAssetMapSearcher.new(:current_mileage => event.current_mileage , :current_mileage_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:current_mileage => event.current_mileage , :current_mileage_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.joins(:asset_events).where('asset_events.current_mileage < ?',  event.current_mileage).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by fta emergency contingency fleet' do
    ...
    searcher = TransitAssetMapSearcher.new(:fta_emergency_contingency_fleet => '1', :organization_id => asset.organization_id)
  ...
  it 'should be able to search by ada accessibility' do
    ...
    searcher = TransitAssetMapSearcher.new(:ada_accessible_ramp => '1', :ada_accessible_lift => '0', :organization_id => asset.organization_id)
  ...
  it 'should be able to search by facility capacity type' do
    ...
    searcher = TransitAssetMapSearcher.new(:facility_capacity_type_id => asset.facility_capacity_type_id, :organization_id => asset.organization_id)
  ...
  it 'should be able to search by FTA Land Ownership Type' do
    ...
    searcher = TransitAssetMapSearcher.new(:land_ownership_type_id => asset.land_ownership_type_id, :organization_id => asset.organization_id)
  ...
  it 'should be able to search by FTA Building Ownership Type' do
    ...
    searcher = TransitAssetMapSearcher.new(:building_ownership_type_id => asset.building_ownership_type_id, :organization_id => asset.organization_id)
  ...
  it 'should be able to search by LEED Certification Type' do
    ...
    searcher = TransitAssetMapSearcher.new(:leed_certification_type_id => asset.leed_certification_type_id, :organization_id => asset.organization_id)
  ...
  it 'should be able to search by facility size' do
    ...
    searcher = TransitAssetMapSearcher.new(:facility_size => asset.facility_size , :facility_size_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:facility_size => asset.facility_size , :facility_size_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('facility_size < ?',  asset.facility_size).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by lot size' do
    ...
    searcher = TransitAssetMapSearcher.new(:lot_size => asset.lot_size , :lot_size_comparator => '0', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where(lot_size: asset.lot_size).where(organization_id: asset.organization_id).count)

    searcher = TransitAssetMapSearcher.new(:lot_size => asset.lot_size , :lot_size_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('lot_size < ?',  asset.lot_size).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by Percent Operational' do
    ...
    searcher = TransitAssetMapSearcher.new(:pcnt_operational => asset.pcnt_operational , :pcnt_operational_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:pcnt_operational => asset.pcnt_operational , :pcnt_operational_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('pcnt_operational < ?',  asset.pcnt_operational).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by number of floors' do
    ...
    searcher = TransitAssetMapSearcher.new(:num_floors => asset.num_floors , :num_floors_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:num_floors => asset.num_floors , :num_floors_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('num_floors < ?',  asset.num_floors).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by number of elevators' do
    ...
    searcher = TransitAssetMapSearcher.new(:num_elevators => asset.num_elevators , :num_elevators_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:num_elevators => asset.num_elevators , :num_elevators_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('num_elevators < ?',  asset.num_elevators).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by number of escalators' do
    ...
    searcher = TransitAssetMapSearcher.new(:num_escalators => asset.num_escalators , :num_escalators_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:num_escalators => asset.num_escalators , :num_escalators_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('num_escalators < ?',  asset.num_escalators).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by number of structures' do
    ...
    searcher = TransitAssetMapSearcher.new(:num_structures => asset.num_structures , :num_structures_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:num_structures => asset.num_structures , :num_structures_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('num_structures < ?',  asset.num_structures).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by number of private parking spaces' do
    ...
    searcher = TransitAssetMapSearcher.new(:num_parking_spaces_private => asset.num_parking_spaces_private , :num_parking_spaces_private_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:num_parking_spaces_private => asset.num_parking_spaces_private , :num_parking_spaces_private_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('num_parking_spaces_private < ?',  asset.num_parking_spaces_private).where(organization_id: asset.organization_id).count)
  ...
  it 'should be able to search by number of public parking spaces' do
    ...
    searcher = TransitAssetMapSearcher.new(:num_parking_spaces_public => asset.num_parking_spaces_public , :num_parking_spaces_public_comparator => '0', :organization_id => asset.organization_id)
    ...
    searcher = TransitAssetMapSearcher.new(:num_parking_spaces_public => asset.num_parking_spaces_public , :num_parking_spaces_public_comparator => '-1', :organization_id => asset.organization_id)
    expect(searcher.data.count).to eq(Asset.where('num_parking_spaces_public < ?',  asset.num_parking_spaces_public).where(organization_id: asset.organization_id).count)
