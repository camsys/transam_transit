...
describe "assets/_locomotive_purchase.html.haml", :type => :view do
  it 'purchase info' do
    test_asset = create(:buslike_asset, :purchase_cost => 1234, :purchase_date => Date.new(2010,1,1), :warranty_date => Date.new(2010,2,1), :in_service_date => Date.new(2010,3,1), :vendor => create(:vendor), :title_number => 'abc123', :title_owner_organization_id => create(:organization).id)
