...
describe "assets/_support_facility_purchase.html.haml", :type => :view do
  it 'purchase info' do
    test_asset = create(:administration_building, :purchase_cost => 1234, :purchase_date => Date.new(2010,1,1), :warranty_date => Date.new(2010,2,1), :in_service_date => Date.new(2010,3,1), :vendor => create(:vendor), :land_ownership_type_id => 1, :land_ownership_organization => create(:organization), :building_ownership_type_id => 2, :building_ownership_organization => create(:organization))
