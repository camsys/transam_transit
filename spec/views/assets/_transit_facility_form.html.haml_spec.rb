...
describe "assets/_transit_facility_form.html.haml", :type => :view do
  it 'fields' do
    assign(:organization, create(:organization))
    assign(:asset, TransitFacility.new)
    render
    ...
    expect(rendered).to have_field('asset_num_escalators')
    ...
    expect(rendered).to have_field('asset_facility_feature_ids_1')
