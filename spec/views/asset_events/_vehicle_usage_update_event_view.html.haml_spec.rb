...
describe "asset_events/_vehicle_usage_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:vehicle_usage_update_event, :pcnt_5311_routes => 33, :avg_daily_use_hours => 17, :avg_daily_use_miles => 222, :avg_daily_passenger_trips => 11, :event_date => Date.new(3017,1,1), :comments => 'test comment 900'))
