...
describe "asset_events/_maintenance_provider_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:maintenance_provider_update_event, :maintenance_provider_type_id => MaintenanceProviderType.first.id, :comments => 'test comment 123'))
