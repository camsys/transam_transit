...
describe "asset_events/_storage_method_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:storage_method_update_event, :vehicle_storage_method_type_id => 1, :event_date => Date.new(3017,1,1), :comments => 'test comment 900'))
