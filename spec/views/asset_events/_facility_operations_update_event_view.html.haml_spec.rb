...
describe "asset_events/_facility_operations_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:facility_operations_update_event, :annual_affected_ridership => 123, :annual_dollars_generated => 4560, :event_date => Date.new(2017,1,1), :comments => 'test comment 900'))
