...
describe "asset_events/_operations_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:operations_update_event, :avg_cost_per_mile => 2.33, :avg_miles_per_gallon => 24.4, :annual_maintenance_cost => 4000, :annual_insurance_cost => 1000, :event_date => Date.new(3017,1,1), :comments => 'test comment 900'))
