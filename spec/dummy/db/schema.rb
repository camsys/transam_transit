...
ActiveRecord::Schema.define(version: 20150121014546) do
  ...
  create_table "activity_logs", force: true do |t|
    ...
    t.text     "activity",        limit: 16777215,                                 null: false
  ...
  add_index "asset_groups", ["object_key"], name: "asset_groups_idx1", unique: true, using: :btree
  ...
  add_index "asset_types_manufacturers", ["asset_type_id", "manufacturer_id"], name: "asset_types_manufacturersidx1", using: :btree
  ...
  create_table "assets", force: true do |t|
    ...
    t.integer  "vendor_id"
    t.integer  "fta_bus_mode_type_id",                                                    default: 0
  end
  ...
  add_index "capital_projects_mpms_projects", ["capital_project_id", "mpms_project_id"], name: "capital_projects_mpms_projects_idx1", using: :btree
  ...
  create_table "contact_types_users", id: false, force: true do |t|
    t.integer "contact_type_id", null: false
    t.integer "user_id",         null: false
  end

  add_index "contact_types_users", ["contact_type_id", "user_id"], name: "contact_types_users_idx1", using: :btree
  ...
  add_index "forms", ["object_key"], name: "forms_idx1", unique: true, using: :btree
  ...
  add_index "funding_amounts", ["funding_source_id", "fy_year"], name: "funding_amounts_idx2", using: :btree
  add_index "funding_amounts", ["object_key"], name: "funding_amounts_idx1", using: :btree
  ...
  create_table "keyword_search_indices", force: true do |t|
    t.string   "object_class",    limit: 64
    t.string   "object_key",      limit: 12
    t.integer  "organization_id",            null: false
  ...
  add_index "mpms_projects", ["capital_project_id"], name: "mpms_projects_idx1", using: :btree
  ...
  add_index "notes", ["asset_id"], name: "notes_idx2", using: :btree
  add_index "notes", ["object_key"], name: "notes_idx1", using: :btree
  ...
  add_index "organizations", ["short_name"], name: "short_name", unique: true, using: :btree
  add_index "organizations", ["urban_rural_type_id"], name: "orgnizations_idx5", using: :btree
  ...
  add_index "organizations_service_types", ["organization_id", "service_type_id"], name: "organizations_service_types_idx1", using: :btree
  ...
  create_table "policy_items", force: true do |t|
    ...
    t.integer  "asset_subtype_id",                                      null: false
    t.integer  "max_service_life_months",                               null: false
  ...
  add_index "policy_items", ["asset_subtype_id"], name: "policy_items_idx2", using: :btree
  add_index "policy_items", ["policy_id"], name: "policy_items_idx1", using: :btree
  ...
  add_index "user_organization_filters_organizations", ["user_organization_filter_id", "organization_id"], name: "user_organization_filters_idx3", using: :btree
  ...
  add_index "vendors", ["object_key"], name: "vendors_idx1", unique: true, using: :btree
