...
ActiveRecord::Schema.define(version: 2022_03_28_190326) do
  ...
  create_table "planning_partners_organizations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "rta_org_credentials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "organization_id"
